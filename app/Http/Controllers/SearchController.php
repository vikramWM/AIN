        ...
        $output .= '<script>
                    ...
                    $output .= '<td>' .  $index++. '</td>
                        ...
                        <td>' . $order->order_date . '</td>
                            ...
                            <td>' . ($order->follow_status == 'negative but convinced' || $order->follow_status == 'negative' ? '<span class="badge badge-light-danger fs-7 fw-bold">' . $order->follow_status . '</span><br>' : ($order->follow_status == 'positive' || $order->follow_status == 'positive and referal' ? '<span class="badge badge-light-warning fs-7 fw-bold">' . $order->follow_status . '</span><br>' : ($order->follow_status == 'positive and own order' ? '<span class="badge badge-light-success fs-7 fw-bold">' . $order->follow_status . '</span><br>' : ($order->follow_status == 'No response' ? '<span class="badge badge-light-primary fs-7 fw-bold">' . $order->follow_status . '</span><br>' : '')))) . '</td>
                      
                            <td>' . $order->follow_comment . '</td>
