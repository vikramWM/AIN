...
<section class="banner-section-three">
    <div class="pattern-layer-two"
        style="background-image: url(images/bubble.png); background-size: contain; background-position: center; background-repeat: no-repeat;">
    </div>
    ...
    <section class=" banner-section-three">
                    ...
                    <div class="auto-container" style="margin-top: 100px;">
                        ...
                        <div class="row clearfix mt-5">
                            ...
                            <div class="content-column col-lg-12 col-md-12 col-sm-12">
                                <div class="card mx-auto" style="width: 80%;">
                                    <img src="images/recommend and earn money.png" alt="" srcset=""
                                        style="height:230px;">
                        ...
                        <div class="row clearfix mt-5">
                            ...
                            <div class="content-column col-lg-12 col-md-12 col-sm-12">
                                <div class="card mx-auto" style="width: 80%;">
                                    <img src="images/refer friend ten percent amount.png" alt="" srcset=""
                                        style="height:250px;">
