            ...
            <form action="{{ route('status.update', ['id' => $order->id]) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <select name="status" class="form-control" required>
                        ...
                        <option <?php if($order->status_issue == "Client Discussion Done") { echo 'selected'; } ?> value="Client Discussion Done">Client Discussion Done</option>
                        <option <?php if($order->status_issue == "Writer discussion Done") { echo 'selected'; } ?> value="Writer discussion Done">Client's Discussion</option>
                        <option <?php if($order->status_issue == "Work in progress") { echo 'selected'; } ?> value="Work in progress">Writer Discussion</option>
