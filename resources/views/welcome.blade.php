			...
			<div class="row clearfix">
				<div class="column col-lg-6 col-md-12 col-sm-12">
					...
					<ul class="accordion-box">
						<li class="accordion block">
							<div class="acc-btn">1. Is it available for students in the UK only, or can international students also use the service? <div class="icon fa fa-angle-down"></div></div>
						...
						<li class="accordion block active-block">
							<div class="acc-btn active">2. Why I have to choose Assignment In Need, and how can it assist me with my assignments? <div class="icon fa fa-angle-down"></div></div>
						...
						<li class="accordion block">
							<div class="acc-btn">3. Are you provide original and plagiarism-free content?<div class="icon fa fa-angle-down"></div></div>
						...
						<li class="accordion block">
							<div class="acc-btn">4. How do I place an order for assignment help?<div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>
						...
						<li class="accordion block">
							<div class="acc-btn">5. Can I choose a specific writer for my assignment, especially if I have worked with them before? <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>										
						...
						<li class="accordion block">
							<div class="acc-btn">6. What subjects and academic levels does Assignment In Need cover? <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>
						...
						<li class="accordion block">
							<div class="acc-btn">7. How does Assignment In Need ensure data privacy and confidentiality? <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>										
						...
						<li class="accordion block">
							<div class="acc-btn">8. Can I track the progress of my assignment as it's being completed?<div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>					
						...
						<li class="accordion block">
							<div class="acc-btn">9. How can I be sure that my assignment will meet my institution's guidelines for formatting style? <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>															
						...
						<li class="accordion block">
							<div class="acc-btn">10. How can I request a revision for my assignment? <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content" style="">
								<div class="content">
									<div class="text">
										<p>										
				...
				<div class="column col-lg-6 col-md-12 col-sm-12">
					...
					<ul class="accordion-box">
						...
						<li class="accordion block active-block">
							<div class="acc-btn active">2. Why is there a Need of Help in Assignment Writing London,UK?<div class="icon fa fa-angle-down"></div></div>
						...
						<li class="accordion block">
							<div class="acc-btn">3. Assignment Writing Services in the London, UK <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content">
								<div class="content">
									<div class="text">
										<p>
						...
						<li class="accordion block">
							<div class="acc-btn">4. Online Assignment Writing Help in the UK <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content">
								<div class="content">
									<div class="text">
										<p>
						...
						<li class="accordion block">
							<div class="acc-btn">5. Help in Assignment Writing London,UK <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content">
								<div class="content">
									<div class="text">
										<p>
						...
						<li class="accordion block">
							<div class="acc-btn">6. Conclusion <div class="icon fa fa-angle-down"></div></div>
							<div class="acc-content">
								<div class="content">
									<div class="text">
										<p>
